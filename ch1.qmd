...
<!-- Hmisc::knitrSet(basename="intro", fig.path="figs/g", w=7, h=7) -->
<!-- oldopt <- options(digits=4, formatR.arrow=FALSE, width=70, scipen=999) -->
<!-- knitr::render_listings() -->
<!-- library(knitr) -->
<!-- opts_chunk$set(cache.path='cache-', fig.align='center', fig.show='hold', size="small", ps=10, out.width="0.8\\textwidth", comment=NA) -->
<!-- opts_chunk[['set']](cache.path='cache-', out.width="0.8\\textwidth",  -->
<!--                     fig.align="center", -->
<!--                     fig.show='hold', size="small", ps=10, strip.white = TRUE, -->
<!--                     out.width="0.8\\textwidth", comment=NA, -->
<!--                     width=70, comment=NA, tidy.opts = list(replace.assign=FALSE)) -->
<!-- ``` -->
